...
const destinos = [
  {
    nombre: "Chefchaouen",  pais: "Marruecos",    precio: 1150 ,
    imagenes: ["img2/Chefchaouen1.jpg"],  slider: ["img2/tokio1.jpg", "img2/tokio2.jpg", "img2/tokio3.jpg"]
  },

  {
    nombre: "Colmar", pais: "Francia",  precio: 1350,
    imagenes: ["img2/colmar1.jpg"],  slider: ["img2/paris1.jpg", "img2/paris2.jpg", "img2/paris3.jpg"]
  },

  {
    nombre: "Hallstatt", pais: "Austria",  precio: 1400,
    imagenes: ["img2/Hallstatt.jpg"],  slider: ["img2/londres1.jpg","img2/londres2.jpg","img2/londres3.jpg"]
  },

  {
    nombre: "Rovinj",  pais: "Croacia",  precio: 1200,
    imagenes: ["img2/Rovinj.jpg"],  slider: ["img2/ny1.jpg","img2/ny2.jpg","img2/ny3.jpg"]
  },

  {
    nombre: "Giethoorn",  pais: "Países Bajos",  precio: 1450,
    imagenes: ["img2/Giethoorn.jpg"],  slider: ["img2/seul1.jpg","img2/seul2.jpg","img2/seul3.jpg"]
  },

  {
    nombre: "Sintra",  pais: "Portugal", precio: 1150,
    imagenes: ["img2/Sintra.jpg"], slider: ["img2/madrid1.jpg","img2/madrid2.jpg","img2/madrid3.jpg"]
  },

  {
    nombre: "Kotor", pais: "Montenegro",  precio: 1150,
    imagenes: ["img2/kotor.jpg"],  slider: ["img2/barcelona1.jpg","img2/barcelona2.jpg","img2/barcelona3.jpg"]
  },

  { nombre: "Mostar", pais: "Bosnia y Herzegovina", precio: 1100,
    imagenes:["img2/Mostar.jpg"], slider:["img2/roma1.jpg","img2/roma2.jpg","img2/roma3.jpg"] },

  { nombre: "Wrocław", pais: "Polonia", precio: 1000,
    imagenes:["img2/Wrocław.jpg"], slider:["img2/dubai1.jpg","img2/dubai2.jpg","img2/dubai3.jpg"] },

  { nombre: "Sighișoara", pais: "Rumania", precio: 970,
    imagenes:["img2/Sighișoara.jpg"], slider:["img2/sidney1.jpg","img2/sidney2.jpg","img2/sidney3.jpg"] },

  { nombre: "Veliko Tarnovo", pais: "Bulgaria", precio: 1000,
    imagenes:["img2/Veliko Tarnovo.jpg"], slider:["img2/melbourne1.jpg","img2/melbourne2.jpg","img2/melbourne3.jpg"] },

  { nombre: "Cesky Krumlov", pais: "República Checa", precio: 1070,
    imagenes:["img2/Cesky Krumlov.jpg"], slider:["img2/toronto1.jpg","img2/toronto2.jpg","img2/toronto3.jpg"] },

  { nombre: "Takayama", pais: "Japón", precio: 1450,
    imagenes:["img2/Takayama.jpg"], slider:["img2/vancouver1.jpg","img2/vancouver2.jpg","img2/vancouver3.jpg"] },

  { nombre: "Jiufen", pais: "Taiwán", precio: 1150,
    imagenes:["img2/Jiufen.jpg"], slider:["img2/praga1.jpg","img2/praga2.jpg","img2/praga3.jpg"] },

  { nombre: "Luan Prabang", pais: "Laos", precio: 1200,
    imagenes:["img2/LuanPrabang.jpg"], slider:["img2/budapest1.jpg","img2/budapest2.jpg","img2/budapest3.jpg"] },
...
if (sliderModal && sliderImages) {
  ...
  function abrirSlider(nombre) {
    ...
    currentImages.forEach((img2, i) => {
      const el = document.createElement("img2");
      el.src = img2;
...
(function DestinoDetalleModule() {
  ...
  function populateModal(dest) {
    ...
    const img2s = Array.isArray(dest.imagenes) && dest.imagenes.length ? dest.imagenes : ["img2/default1.jpg"];
    img2s.forEach(src => {
